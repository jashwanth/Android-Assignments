...
/**
 * Created by bssan_000 on 6/12/2015.
 */
...
public class MovieDataJSONLocal {
    ...
    public void loadLocalMovieDataJson(Context context) {
        ...
        String moviesArray = loadFileFromAsset(context, "movie.json");
        if (moviesArray == null){
        ...
        try {
            ...
            for (int i = 0; i < moviesJsonArray.length(); i++) {
                ...
                if (movieJsonObj != null) {
                    ...
                    String runTime = (String) movieJsonObj.get("length");
                    ...
                    moviesList.add(createMovie(name, resID, description, year, runTime, rating, director, stars, url, id));
                }
            }
