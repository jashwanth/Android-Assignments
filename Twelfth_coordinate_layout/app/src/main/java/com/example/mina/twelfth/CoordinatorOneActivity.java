...
public class CoordinatorOneActivity extends AppCompatActivity implements RecyclerViewFragment.OnListItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText("CoordinatorLayout One");
    ...
    public void onListItemSelected(int position, HashMap<String, ?> movie) {
        Intent myIntent = new Intent(CoordinatorOneActivity.this, MovieDetailActivity.class);
