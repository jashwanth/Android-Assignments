...
public class Activity_DragandDrop extends AppCompatActivity implements OnItemSelectedListener {
    ...
    public void onItemSelected(HashMap<String, ?> movie, View sharedImage) {
        Fragment_DetailView details = Fragment_DetailView.newInstance(movie);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private final class MyClickListener implements View.OnClickListener {
            ...
            public void onClick(View view){
                ...
                HashMap<String,?> movie = (HashMap<String,?>) moviesList.get(id);
