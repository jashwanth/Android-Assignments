    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View.OnClickListener onClickListener = new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                switch (id){
                    case R.id.button1:
                        Log.d("MainActivity", "onClick: Button1 clicked ");
                    ...
                    case R.id.button3:
                        ...
                        break;
                    case R.id.button4:
                        Log.d("MainActivity", "onClick: RecyclerView has been clicked ");
                        intent = new Intent(getActivity(), Activity_Animation.class);
                        startActivity(intent);
                        break;

                    case R.id.recycerviewbutton:
                        Log.d("MainActivity", "onClick: RecyclerView has been clicked ");
        ...
        ((Button) rootView.findViewById(R.id.recycerviewbutton)).setOnClickListener(onClickListener);
        return rootView;
    }
}
