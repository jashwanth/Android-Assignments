...
public class MapThreeActivity extends AppCompatActivity
    ...
    private static final LatLng DEFAULT_LOCATION = new LatLng(43.0481, -76.1474);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapthree);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                for(Place place : places){
                    ...
                    Marker item = myGoogleMap.addMarker(markerOptions);
    ...
    {
        myGoogleMap.clear();//지도 클리어

        if (previous_marker != null)
            previous_marker.clear();//지역정보 마커 클리어

        if(type == 1) { // restaurant
            new NRPlaces.Builder()
                    .listener(MapThreeActivity.this)
                    .key(getString(R.string.google_maps_key))
                    .latlng(location.latitude, location.longitude)// current location
                    .radius(500) //within 500 m
                    .type(PlaceType.RESTAURANT) // type of search
                    .build()
                    .execute();
        }
        else if(type == 2) { // all
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MapThreeActivity.this);
